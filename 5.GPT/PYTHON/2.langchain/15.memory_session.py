...
print(chain_with_memory.invoke({"input": "방금 내가 이야기한 말은 뭐였지?"}, config={"configurable": {"session_id": session_id1}}))
print(chain_with_memory.invoke({"input": "방금 내가 이야기한 말은 뭐였지?"}, config={"configurable": {"session_id": session_id2}}))
print(chain_with_memory.invoke({"input": "방금 내가 이야기한 말은 뭐였지?"}, config={"configurable": {"session_id": session_id2}}))
